...
const Sticker = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
        ...
        <Image source={{uri:'https://giphy.com/static/img/about/stickers/logo-spin.gif'}} style={{width:60,height:60,right:90,top:35}} />
        <Text style={styles.headerboxTitle}>Sticker</Text>
        </View>
        <SearchBar
          round
          searchIcon={{ size: 24 }}
