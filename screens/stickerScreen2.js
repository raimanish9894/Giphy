...
const Sticker2 = () => {
    ...
    useEffect(()=> {
        fetch('https://api.giphy.com/v1/stickers/trending?api_key=B0BpQD2SFbDeoxRTxNVANCrGSDSq4Pjt&limit=40&rating=pg')
        .then((res)=>res.json())
        .then((res)=>{
  ...
  return (
    <SafeAreaView style={styles.container}>
        ...
        <Image source={{uri:'https://giphy.com/static/img/about/stickers/logo-spin.gif'}} style={{width:50,height:50,right:130,top:45}} />
        <Text style={styles.headerboxTitle}>Sticker Childrens</Text>
        </View>
        <SearchBar
          round
          searchIcon={{ size: 24 }}
